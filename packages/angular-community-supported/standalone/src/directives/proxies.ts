...
import { defineCustomElement as defineIcPaginationBar } from '@ukic/web-components/components/ic-pagination-bar.js';
...
@ProxyCmp({
  defineCustomElementFn: defineIcPaginationBar,
