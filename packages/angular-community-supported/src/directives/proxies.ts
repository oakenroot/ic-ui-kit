...
import type { IcAlertCustomEvent } from '@ukic/web-components';
...
import type { IcButtonCustomEvent } from '@ukic/web-components';
...
import type { IcCheckboxCustomEvent } from '@ukic/web-components';
...
import type { IcCheckboxGroupCustomEvent } from '@ukic/web-components';
...
import type { IcChipCustomEvent } from '@ukic/web-components';
...
import type { IcDialogCustomEvent } from '@ukic/web-components';
...
import type { IcMenuCustomEvent } from '@ukic/web-components';
...
import type { IcMenuItemCustomEvent } from '@ukic/web-components';
...
import type { IcPaginationCustomEvent } from '@ukic/web-components';
...
import type { IcPaginationBarCustomEvent } from '@ukic/web-components';
...
import type { IcPopoverMenuCustomEvent } from '@ukic/web-components';
...
import type { IcRadioGroupCustomEvent } from '@ukic/web-components';
...
import type { IcRadioOptionCustomEvent } from '@ukic/web-components';
...
import type { IcSearchBarCustomEvent } from '@ukic/web-components';
...
import type { IcSelectCustomEvent } from '@ukic/web-components';
...
import type { IcSideNavigationCustomEvent } from '@ukic/web-components';
...
import type { IcSwitchCustomEvent } from '@ukic/web-components';
...
import type { IcTabContextCustomEvent } from '@ukic/web-components';
...
import type { IcTextFieldCustomEvent } from '@ukic/web-components';
import type { IcValueEventDetail as IIcTextFieldIcValueEventDetail } from '@ukic/web-components';
import type { IcTextFieldKeydownEventDetail as IIcTextFieldIcTextFieldKeydownEventDetail } from '@ukic/web-components';
...
import type { IcThemeCustomEvent } from '@ukic/web-components';
...
import type { IcToastCustomEvent } from '@ukic/web-components';
...
import type { IcToggleButtonCustomEvent } from '@ukic/web-components';
...
import type { IcToggleButtonGroupCustomEvent } from '@ukic/web-components';
...
@ProxyCmp({
  inputs: ['disableClick', 'disableHover', 'fixedPositioning', 'iconAltText', 'label', 'maxLines', 'placement', 'target', 'theme'],
...
@Component({
  ...
  template: '<ng-content></ng-content>',
  // eslint-disable-next-line @angular-eslint/no-inputs-metadata-property
  inputs: ['disableClick', 'disableHover', 'fixedPositioning', 'iconAltText', { name: 'label', required: true }, 'maxLines', 'placement', 'target', 'theme'],
...
import type { IcTooltipCustomEvent } from '@ukic/web-components';
...
import type { IcTopNavigationCustomEvent } from '@ukic/web-components';
