...
const DEFAULT_TEST_THRESHOLD_MOBILE = 0.014;
...
describe("IcTopNavigation desktop visual regression tests", () => {
  ...
  it("should render with focus indicator on navigation item", () => {
    mount(<WithNavItems />);
    cy.checkHydrated(TOP_NAV_SELECTOR);

    cy.findShadowEl(NAV_BUTTON_SELECTOR, "ic-button").realClick();
    cy.wait(500).realPress("Tab");

    cy.wait(500).checkA11yWithWait();
    cy.compareSnapshot({
      name: "/navigation-item-with-focus-indicator",
      testThreshold: setThresholdBasedOnEnv(DEFAULT_TEST_THRESHOLD + 0.006),
    });
  });
  ...
  it("should render with dark theme sunrise brand", () => {
    mount(
  ...
  it("should render with light theme sunrise brand", () => {
    mount(
      <IcTheme brandColor="rgb(255, 201, 60)">
        <ThemeLight />
      </IcTheme>
...
describe("IcTopNavigation mobile visual regression tests", () => {
  ...
  it("should render search", () => {
    ...
    cy.clickOnShadowEl(TOP_NAV_SELECTOR, "ic-button#search-toggle-button");

    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "/mobile-search",
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.027
      ),
    });
  });
  ...
  it("should render icon buttons", () => {
    ...
    cy.compareSnapshot({
      ...
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.036
      ),
    });
  });
  ...
  it("should render icon buttons in dark theme", () => {
    ...
    cy.compareSnapshot({
      ...
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.025
      ),
    });
  });
  ...
  it("should render with long text values - open", () => {
    mount(<LongText />);
    cy.checkHydrated(TOP_NAV_SELECTOR);
    ...
    cy.checkA11yWithWait();
    cy.compareSnapshot({
      name: "/mobile-long-text-open",
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.048
      ),
    });
  });
  ...
  it("should render with navigation items", () => {
    ...
    cy.compareSnapshot({
      ...
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.033
      ),
    });
  });
  ...
  it("should render with content centre aligned", () => {
    ...
    cy.compareSnapshot({
      ...
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.019
      ),
    });
  });
  ...
  it("should render with dark theme - mobile", () => {
    ...
    cy.compareSnapshot({
      ...
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.023
      ),
    });
  });
  ...
  it("should render with dark theme - mobile - menu open", () => {
    ...
    cy.compareSnapshot({
      ...
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.029
      ),
    });
  });
...
describe("IcTopNavigation mobile visual regression tests in high contrast mode", () => {
  ...
  it("should render mobile menu in high contrast mode", () => {
    mount(<WithNavItems />);
    cy.checkHydrated(TOP_NAV_SELECTOR);

    cy.compareSnapshot({
      name: "/mobile-high-contrast",
      testThreshold: setThresholdBasedOnEnv(
  ...
  it("should render with menu open in high contrast mode", () => {
    ...
    cy.compareSnapshot({
      ...
      testThreshold: setThresholdBasedOnEnv(
        DEFAULT_TEST_THRESHOLD_MOBILE + 0.046
      ),
    });
  });
});
