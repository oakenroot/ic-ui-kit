...
| `tooltipFixedPositioning` | `tooltip-fixed-positioning` | Setting to `true` can help in situations where tooltip content is clipped by a parent element.                                                                        | `boolean`                                                                                                                                                                                             | `false`                                            |
