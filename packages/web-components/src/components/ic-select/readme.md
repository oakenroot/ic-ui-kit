...
| `options`                     | --                               | The possible selection options.                                                                                                                                                                                                         | `IcSelectOption[]`                        | `[]`                 |
...
| `useNativeSelectOnMobile`     | `use-native-select-on-mobile`    | If `true` and on a mobile or tablet device, the native select element will be used instead of the custom select component for better usability.                                                                                         | `boolean`                                 | `true`               |
