...
| `hideAppTitle`           | `hide-app-title`           | If `true`, the app title will be hidden, but still accessible to screen readers.                                                                               | `boolean`                            | `false`          |
| `href`                   | `href`                     | The URL to navigate to when the app title or app icon is clicked.                                                                                              | `string`                             | `"/"`            |
