...
| `validationAriaLive`   | `validation-aria-live`   | The value of the `aria-live` attribute on the validation message. When set to "default", the `aria-live` value will be handled automatically, e.g. "assertive" for `validation-status="error"`.                     | `"assertive" \| "default" \| "off" \| "polite"`                                       | `"default"`                                               |
